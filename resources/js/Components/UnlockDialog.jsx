          ...
          `}
                >
                    <div className="relative z-10 p-6 flex flex-col items-center text-white">
                        <h2
                            className="text-5xl font-extrabold mt-8 mb-2"
                            style={{
                                fontFamily: "Cormorant Infant",
                                textShadow:
                                    "0 2px 10px rgba(12, 54, 91, 0.5), 0 0 20px rgba(96, 165, 250, 0.2)",
                            }}
                        >
                            {territoryName}
                        </h2>
                        ...
                        <p
                            className={`text-lg text-cyan-200 font-serif italic text-center max-w-[85%] drop-shadow-md
              ${isAlreadyUnlocked ? "mb-0" : "mb-8"}
             `}
                        >
                        ...
                        {isAlreadyUnlocked ? (
                            ...
                            <div className="flex flex-col gap-4 items-center">
                                <div className="bg-amber-900/30 border border-amber-600/50 rounded-lg p-4 text-center max-w-sm">
                                    <p className="text-amber-200 text-sm font-serif mb-2">
                                        ⚠️ This core is still locked
                                    </p>
                                ...
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="mt-4 relative self-center transition-transform duration-300 hover:scale-110 active:scale-95"
                                >
                                    <img
                                        src={Button}
                                        alt="Back"
